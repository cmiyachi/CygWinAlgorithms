...
int main() {
    ...
    cout << (reverseShuffleMerge("eggegg")) << endl; //== "egg") << endl;

    cout << (reverseShuffleMerge("abcdefgabcdefg")) << endl; //== "agfedcb") << endl;

    // wrong test case, see discussions
    // cout << (reverseShuffleMerge("aeiouuoiea") == "aeiouuoiea") << endl;
}